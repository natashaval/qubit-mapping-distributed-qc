    ...
    def calculate_final_maps(self):
        ...
        while logical_priority:
            ...
            for i in range(len(self.maps)):
                ...
                print("Current", curr_qubit, "Assigned TOUPLE: ", self.assigned_qubits, "PHYSICAL: ", self.assigned_physical_qubits)
                print("Logical: ", logical_priority, " Physical: ", temp_physical_connectivity)
                if self.has_no_neighbor(
                    ...
                    print("Best Physical Qubit: ", best_physical_bit)
                    m_temp = self.add_mapping(
                        [(curr_qubit, phy) for phy in best_physical_bit.keys()],
                        [m],
                        max_qpi_value,
                    )
                    print("After best m_temp: ", m_temp)
