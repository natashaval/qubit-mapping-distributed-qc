\chapter{Methodology} \label{Chap3} % NOT YET TURNITIN, MOSTLY FOUND IN QISKIT DOCUMENTATION AND DYNAMIC LOOKAHEAD
...
\While{logical priority is not empty}
    \For{maps}
        ...
        \If{all $q_L$ neighbor already assigned}
